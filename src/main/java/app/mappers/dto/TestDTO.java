...
public class TestDTO {
     ...
     */
    private final String citizencardnumberDto;
     ...
     * @param citizencardnumberDto the number of the customer's citizen card associated with a test
     ...
     */
    public TestDTO(String citizencardnumberDto, String nhscodeDto, List<TestParameter> testParameterListDto, TestType testTypeDto) {
