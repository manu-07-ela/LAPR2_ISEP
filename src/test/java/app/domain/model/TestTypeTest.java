...
public class TestTypeTest {
    ...
    public void ensureCodeMeetsAC1_4(){
        TestType tt = new TestType("1.3-4","description","method",listPC);
    }
    ...
    @Test
    public void TestTypesNotEquals(){
        TestType tt1 = new TestType("1f5ac", "Test","Test",listPC);
        TestType tt2 = new TestType("1f5dc", "description","collecting",listPC);
        Assert.assertNotEquals(tt1,tt2);
    }
